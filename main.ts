...
scene.onOverlapTile(SpriteKind.udplayer, myTiles.tile8, function (sprite, location) {
    info.setLife(10)
    next_level()
})
...
function next_level () {
    ...
    if (level == 1) {
        ...
        tiles.placeOnRandomTile(portal_lvl_1_lvl_2, myTiles.tile8)
    ...
    if (level == 2) {
        ...
        for (let value of tiles.getTilesByType(myTiles.tile7)) {
            coins = sprites.create(img`
                ...
                `, SpriteKind.coin)
            tiles.placeOnTile(coins, value)
            tiles.setTileAt(value, myTiles.tile18)
        }
        tiles.placeOnTile(snake_player, tiles.getTileLocation(3, 6))
        tiles.placeOnRandomTile(portal_lvl_1_lvl_2, myTiles.tile13)
    }
    if (level == 4) {
        game.gameOver(true)
...
scene.onOverlapTile(SpriteKind.Player, myTiles.tile23, function (sprite, location) {
    ...
    tiles.placeOnRandomTile(godzilla, myTiles.tile23)
...
tiles.placeOnRandomTile(portal_lvl_1_lvl_2, myTiles.tile9)
animation.runImageAnimation(
portal_lvl_1_lvl_2,
[img`
    ...........3........
